...
See the [Registry of Open Data on AWS](https://registry.opendata.aws/nuview-opendata/) entry for this data set.
...
If you have questions about the data, you can create an Issue at the [s22s/nuview-opendata project repo on GitHub](https://github.com/s22s/nuview-opendata).
